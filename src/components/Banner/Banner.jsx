      ...
      <div className="container py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="space-y-5 flex justify-center flex-col xl:max-w-[500px] ">
            ...
            >
              Creemos que trabajar en equipo hace que cualquier proyecto sea mejor
            </motion.h1>
            <motion.p
            ...
            >
              La sinergia de un equipo comprometido y coordinado es la clave para transformar ideas en realidades exitosas.{" "}
            </motion.p>
            <div>
              <motion.button
