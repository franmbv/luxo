      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 md:min-h-[600px] gap-10">
          ...
          <div className="flex flex-col justify-center gap-7 md:pr-8 xl:pr-52 text-center md:text-left pt-20 md:pt-0 px-10">
            ...
            >
              BOCETOS PARA DISEÑOS DE INTERIORES LUJOSOS            
            </motion.h1>
            <motion.p
            ...
            >
             Haga realidad su sueño con ayuda de diseño personalizada y productos seleccionados adaptados a su estilo, espacio y presupuesto.
            </motion.p>
